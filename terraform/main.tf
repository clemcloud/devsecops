# ====== This is the Vpc =======
# To better understand how terraform modules work , b efore writig a code understand why is this important , what are the eseentials it need and what does it needs when the essentials are provided ,that is how production terraform code are written.

# ==============================================================
# devsecops EKS Cluster - Auto Mode
# ==============================================================
